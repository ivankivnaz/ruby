# === object_id method as indentification of an object in memory
class Foo
end
...
# === class method which tells class from which object was instanciated
p "a".class
p 1.class
...
# === using class method to store hash of dishes
class Food
end
